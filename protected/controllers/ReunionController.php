...
class ReunionController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Reunion']))
		{
			...
			$model->REU_COM_correl=$_GET['id'];
			if ($model->REU_fecha==null)
				$model->REU_fecha=DATE('Y-m-d');
			if($model->save())
				$this->redirect(array('admin','id'=>$model->REU_COM_correl));
		}
	...
	public function actionAdmin($id)
	{
		...
		$this->widget(
	        ...
	        'buttons' => array(
        		...
        		'items' => array(
        			array('label'=>'Editar', 'url'=>array('update', 'id'=>$data->REU_correl)),
        			array('label'=>'Eliminar', 'url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$data->REU_correl),'confirm'=>'Esta seguro de borrar este item?')),
        			)
	 ...
	 * @return Reunion the loaded model
	 ...
	 * @param Reunion $model the model to be validated
	 */
