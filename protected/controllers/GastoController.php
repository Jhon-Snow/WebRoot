...
class GastoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Gasto']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->GAS_correl));
		}
	...
	public function actionAdmin()
	{
		...
		$this->widget(
	        ...
	        'buttons' => array(
        		...
        		'items' => array(
        			array('label'=>'Editar', 'url'=>array('update', 'id'=>$data->GAS_correl)),
        			array('label'=>'Eliminar', 'url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$data->GAS_correl),'confirm'=>'Esta seguro de borrar este item?')),
        			)
